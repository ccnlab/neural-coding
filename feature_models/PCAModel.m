classdef PCAModel < FeatureModel
    ...
    methods
        ...
        function obj = PCAModel(varargin)
        ...
        function obj = fit(obj,X)            
            ...
            % NOTE: conflicts with Fieldtrip's PCA
            obj.W = subsref(pca(obj.patch'), substruct('()', {':', 1 : obj.feature_size(3) * obj.feature_size(4)}))';
